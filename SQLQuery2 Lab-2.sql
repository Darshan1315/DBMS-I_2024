...
insert into Bill_Detail(B_ID,P_ID,R_ID,H_ID,P_AdmitDateTime,P_DischargeDateTime,P_Medicine_Charge,P_TotalDays_Charge,P_Doctor_Charge,P_Total_Amount,P_Pending_Amount)
values(6002,5002,2001,101,'2023-11-17 17:02:10:002','2023-11-20 17:02:10:002',5600,6000,1050,12650,1000.)

insert into Bill_Detail(B_ID,P_ID,R_ID,H_ID,P_AdmitDateTime,P_DischargeDateTime,P_Medicine_Charge,P_TotalDays_Charge,P_Doctor_Charge,P_Total_Amount,P_Pending_Amount)
values(6003,5003,2002,103,'2024-01-15 17:30:30:030','2024-01-25 17:30:30:030',100.56,15000,820,15920.56,0)

insert into Bill_Detail(B_ID,P_ID,R_ID,H_ID,P_AdmitDateTime,P_DischargeDateTime,P_Medicine_Charge,P_TotalDays_Charge,P_Doctor_Charge,P_Total_Amount,P_Pending_Amount)
values(6004,5004,2004,103,'2022-01-10 11:11:00:020','2022-01-16 11:11:00:020',1005.2,18000,720.56,19725.76,2500.25)

insert into Bill_Detail(B_ID,P_ID,R_ID,H_ID,P_AdmitDateTime,P_DischargeDateTime,P_Medicine_Charge,P_TotalDays_Charge,P_Doctor_Charge,P_Total_Amount,P_Pending_Amount)
values(6005,5005,2001,101,'2023-12-25 11:30:45:001','2023-12-30 11:30:45:001',752,10000,1500,12254,4000.6)

insert into Bill_Detail(B_ID,P_ID,R_ID,H_ID,P_AdmitDateTime,P_DischargeDateTime,P_Medicine_Charge,P_TotalDays_Charge,P_Doctor_Charge,P_Total_Amount,P_Pending_Amount)
values(6006,5006,2001,101,'2021-02-22 14:15:20:004','2021-02-24 14:15:20:004',6000,4000,320,10320,0)

insert into Bill_Detail(B_ID,P_ID,R_ID,H_ID,P_AdmitDateTime,P_DischargeDateTime,P_Medicine_Charge,P_TotalDays_Charge,P_Doctor_Charge,P_Total_Amount,P_Pending_Amount)
values(6007,5007,2006,104,'2024-02-07 10:45:00:000','2024-02-10 10:45:00:000',4570,13500,600.35,18670.35,6000)

insert into Bill_Detail(B_ID,P_ID,R_ID,H_ID,P_AdmitDateTime,P_DischargeDateTime,P_Medicine_Charge,P_TotalDays_Charge,P_Doctor_Charge,P_Total_Amount,P_Pending_Amount)
values(6006,5008,2010,101,'2023-04-21 13:30:20:000','2023-04-27 13:30:20:000',1600.45,3000,250,4850.45,1500.71)

insert into Bill_Detail(B_ID,P_ID,R_ID,H_ID,P_AdmitDateTime,P_DischargeDateTime,P_Medicine_Charge,P_TotalDays_Charge,P_Doctor_Charge,P_Total_Amount,P_Pending_Amount)
values(6009,5009,2003,104,'2022-08-04 10:45:20:004','2022-08-13 10:45:20:004',2600,40500,2000,45100,5000)

insert into Bill_Detail(B_ID,P_ID,R_ID,H_ID,P_AdmitDateTime,P_DischargeDateTime,P_Medicine_Charge,P_TotalDays_Charge,P_Doctor_Charge,P_Total_Amount,P_Pending_Amount)
values(6010,5010,2002,103,'2024-02-04 18:25:10:001','2024-02-06 18:25:10:001',3500,3000,400,6900,3500)

select * from Bill_Detail

insert into Transaction_Detail(Tr_ID,Tr_Number,Tr_B_Amout,Tr_DateTime,Tr_Type,B_ID,P_ID,H_ID)
